...
namespace DOANCUOIKI {
    ...
    public partial class NHAKHOADataSet : global::System.Data.DataSet {
        ...
        public partial class PATIENTDataTable : global::System.Data.TypedTableBase<PATIENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PATIENTRow AddPATIENTRow(string ID, string Name, string Address, System.DateTime Birthdate, string Gender, string Phone, byte[] Picture) {
        ...
        public partial class PATIENTRow : global::System.Data.DataRow {
            ...
            public byte[] Picture {
                get {
                    try {
                        return ((byte[])(this[this.tablePATIENT.PictureColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Picture\' in table \'PATIENT\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePATIENT.PictureColumn] = value;
                }
            }
            ...
            public bool IsPictureNull() {
                return this.IsNull(this.tablePATIENT.PictureColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPictureNull() {
                this[this.tablePATIENT.PictureColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DOANCUOIKI.NHAKHOADataSetTableAdapters {
    ...
    public partial class PATIENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[PATIENT] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_" +
                "Name) AND ([Address] = @Original_Address) AND ([Birthdate] = @Original_Birthdate" +
                ") AND ([Gender] = @Original_Gender) AND ([Phone] = @Original_Phone))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[PATIENT] ([ID], [Name], [Address], [Birthdate], [Gender], [Phone], [Picture]) VALUES (@ID, @Name, @Address, @Birthdate, @Gender, @Phone, @Picture);
SELECT ID, Name, Address, Birthdate, Gender, Phone, Picture FROM PATIENT WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PATIENT] SET [ID] = @ID, [Name] = @Name, [Address] = @Address, [Birthdate] = @Birthdate, [Gender] = @Gender, [Phone] = @Phone, [Picture] = @Picture WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([Birthdate] = @Original_Birthdate) AND ([Gender] = @Original_Gender) AND ([Phone] = @Original_Phone));
SELECT ID, Name, Address, Birthdate, Gender, Phone, Picture FROM PATIENT WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Address, Birthdate, Gender, Phone, Picture FROM dbo.PATIENT";
        ...
        public virtual int Fill(NHAKHOADataSet.PATIENTDataTable dataTable) {
        ...
        public virtual NHAKHOADataSet.PATIENTDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NHAKHOADataSet.PATIENTDataTable dataTable = new NHAKHOADataSet.PATIENTDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NHAKHOADataSet.PATIENTDataTable dataTable) {
        ...
        public virtual int Delete(string Original_ID, string Original_Name, string Original_Address, System.DateTime Original_Birthdate, string Original_Gender, string Original_Phone) {
            if ((Original_ID == null)) {
        ...
        public virtual int Insert(string ID, string Name, string Address, System.DateTime Birthdate, string Gender, string Phone, byte[] Picture) {
            if ((ID == null)) {
        ...
        public virtual int Update(string ID, string Name, string Address, System.DateTime Birthdate, string Gender, string Phone, byte[] Picture, string Original_ID, string Original_Name, string Original_Address, System.DateTime Original_Birthdate, string Original_Gender, string Original_Phone) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, System.DateTime Birthdate, string Gender, string Phone, byte[] Picture, string Original_ID, string Original_Name, string Original_Address, System.DateTime Original_Birthdate, string Original_Gender, string Original_Phone) {
            return this.Update(Original_ID, Name, Address, Birthdate, Gender, Phone, Picture, Original_ID, Original_Name, Original_Address, Original_Birthdate, Original_Gender, Original_Phone);
        }
    }
